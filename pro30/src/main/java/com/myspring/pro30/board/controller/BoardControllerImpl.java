...
public class BoardControllerImpl  implements BoardController{
	private static final String ARTICLE_IMAGE_REPO = "/Users/kim/Documents/2021/fileupdowntest";
	@Autowired
...
//	}
  ...
  public ResponseEntity modArticle(MultipartHttpServletRequest multipartRequest,  
    ...
    try {
       ...
       if(imageFileName!=null && imageFileName.size()!=0) {
       	for(String imageFileNames :imageFileName) {
  ...
  public ResponseEntity  addNewArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception {
	...
	@RequestParam(value = "parentNO", required=false ) Integer parentNO) throws Exception {
		String viewName = (String)request.getAttribute("viewName");
		ModelAndView mav = new ModelAndView();
	...
	public ResponseEntity addReplyArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response)
		...
		String check_Account = boardService._board_Account(articleMap);
		if(check_Account==null || check_Account==""){
			message = "<script>";
			message += " alert('아이디 및 패스워드가 일치하지 않습니다.');";
			message += " location.href='" + multipartRequest.getContextPath() + "/board/listArticles.do'; ";
			message += " </script>";
			resEnt = new ResponseEntity(message, responseHeaders, HttpStatus.CREATED);
			return resEnt;
			...
			try {
				int articleNO = boardService.insertReplyArticle(articleMap);
				if (imageFileList != null && imageFileList.size() != 0) {
					for (ImageVO imageVO : imageFileList) {
						imageFileName = imageVO.getImageFileName();
						File srcFile = new File(ARTICLE_IMAGE_REPO + "/" + "temp" + "/" + imageFileName);
...
//			System.out.println("real file name ="+imageFileName);
